...
Write-Host '[2/3] Installing core libraries (Gemini SDK, Pillow, OBS WebSocket, MSS, Speech)...' -ForegroundColor Yellow
python -m pip install --user google-genai obsws-python pillow mss SpeechRecognition
