...
echo -e "\033[93m[2/3] Installing core libraries (Gemini SDK, Pillow, OBS WebSocket, MSS, Speech, TTS)...\033[0m"
python3 -m pip install --user google-genai obsws-python pillow mss SpeechRecognition edge-tts
